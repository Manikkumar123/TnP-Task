          ...
          <div className="navbar h-[5.5vw] w-[90vw] mx-auto rounded-3xl bg-white/50 backdrop-blur border border-white/20">
            <div className="container flex justify-between items-center h-full px-5">
              <div className="img_container flex items-center gap-6 text-black uppercase">
                ...
                <h2 ref={headingRef} className="font-bold text-[#7f3b2d] text-3xl heading">
                  Training & Placement Cell
                </h2>
              </div>
              <div className="nav_info flex gap-10 text-[1.5vw] font-semibold text-[#7f3b2d]">
                <a className="opacity-0 translate-y-2 hover:underline hover:text-gray-900 transition-all" href="/">Home</a>
                <a className="opacity-0 translate-y-2 hover:underline hover:text-gray-900 transition-all ml-8" href="#">About</a>
                <a
                  className="opacity-0 translate-y-2 flex items-center gap-1 hover:underline hover:text-gray-900 transition-all"
                  href="/login"
                >
